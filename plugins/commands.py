...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [
            [
                InlineKeyboardButton('⚡ CHANNEL ⚡', url='https://t.me/tamilnew_movieschat4')
            ],
            [
                InlineKeyboardButton('⚡ CHANNEL ⚡', url=f"https://t.me/tamilnew_movieschat4"),
            ],
            [
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('⚡ CHANNEL ⚡', url='https://t.me/tamilnew_movieschat4'),
            InlineKeyboardButton('⚡ DISCUSSION ⚡', url='https://t.me/tamilnew_movieschat4')
            ],[
    ...
    await client.send_cached_media(
        ...
        file_id=file_id,
        caption=f_caption,
        reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('JOIN NOW', url='https://t.me/tamilnew_movieschat4') ] ] ),
        protect_content=True if pre == 'filep' else False,
        )
